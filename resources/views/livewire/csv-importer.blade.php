                        ...
                        <div class="h-0 flex-1 overflow-y-auto">
                            <div class="flex flex-1 flex-col justify-between">
                                <div class="p-4 sm:p-6">
                                    ...
                                    @error('file') <span class="mt-2 text-red-500 font-medium text-sm">{{ $message }}</span> @enderror
                                    <!-- End file drop -->
                                                ...
                                                @foreach($columnsToMap as $column => $value)
                                                    <div class="grid grid-cols-4 gap-4 items-start">
                                                        ...
                                                        <div class="mt-1 sm:mt-0 sm:col-span-3">
                                                            ...
                                                            @error('columnsToMap.' . $column) <span class="mt-2 text-red-500 font-medium text-sm">{{ $message }}</span> @enderror
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
